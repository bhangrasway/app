...
const I18N = {
    en: {
        ...
        classes_note: '⚠️ Timings may vary occasionally — please message or call ahead before coming.',
        ...
        gallery_note: 'Photos and videos from our classes and performances — coming soon!',
    ...
    it: {
        ...
        classes_note: "⚠️ Gli orari possono variare occasionalmente — scrivici o chiamaci prima di venire.",
        ...
        gallery_note: 'Foto e video delle nostre lezioni ed esibizioni — in arrivo presto!',
    ...
    pa: {
        ...
        about_body: 'Bhangra Sway Cremona, Cremona vich Punjabi Bhangra di energy lyi aunda hai. Asi bacchiyan te vaddeyan, naveyan te tajurbekaar dancers, local Punjabi community te Bhangra baare curious har kise da swagat karde haan — shuru karan lyi kise tajurbe di lod nahi.',
        classes_heading: 'Saadiyan Classes',
        classes_note: '⚠️ Timing kadi kadi badal sakdi hai — auan ton pehlan message ja call zaroor karo.',
        class_advance_name: 'Advance',
        class_advance_time: 'Saturday, 1:30 PM – 3:30 PM',
        class_intermediate_name: 'Intermediate',
        class_intermediate_time: 'Saturday, 3:30 PM – 5:30 PM',
        ...
        gallery_heading: 'Gallery',
        gallery_note: 'Saadiyan classes te performances diyan photos/videos — jaldi aa rahiyan han!',
