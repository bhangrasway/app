...
const I18N = {
    en: {
        ...
        passcode_reset_sent_body: "Your instructor has been notified. Once approved, you can log in with just your mobile number, or set a new passcode.",
    ...
    it: {
        ...
        passcode_reset_sent_body: "Il tuo istruttore è stato avvisato. Una volta approvata, potrai accedere di nuovo solo con il numero di telefono, oppure impostare un nuovo codice.",
    ...
    pa: {
        ...
        passcode_reset_sent_body: "Tuhade instructor nu dass ditta gaya hai. Approve hon baad tusi sirf mobile number naal login kar sakde ho, ja nava passcode set kar sakde ho.",
        // member.html: placeholder
