...
const I18N = {
    en: {
        ...
        advance_paid_note_one: '🎉 Great news! Your next cycle is already paid in advance — nothing more to pay right now. It starts automatically when this cycle wraps up.',
        advance_paid_note_many: '🎉 Great news! Your next {n} cycles are already paid in advance — nothing more to pay right now. The next one starts automatically when this cycle wraps up.',
    ...
    it: {
        ...
        advance_paid_note_one: '🎉 Ottima notizia! Il tuo prossimo ciclo è già pagato in anticipo — per ora non c\'è altro da pagare. Inizierà automaticamente quando finisce questo ciclo.',
        advance_paid_note_many: '🎉 Ottima notizia! I tuoi prossimi {n} cicli sono già pagati in anticipo — per ora non c\'è altro da pagare. Il prossimo inizierà automaticamente quando finisce questo ciclo.',
    ...
    pa: {
        ...
        advance_paid_note_one: '🎉 Vadhiya khabar! Tuhada agla cycle pehlan hi advance vich paid hai — hun hor kujh nahi dena. Eh cycle khatam hon te agla aap hi shuru ho javega.',
        advance_paid_note_many: '🎉 Vadhiya khabar! Tuhade agle {n} cycle pehlan hi advance vich paid han — hun hor kujh nahi dena. Eh cycle khatam hon te agla aap hi shuru ho javega.',
