...
const I18N = {
    en: {
        ...
        too_far_body: "Your phone's location says you're more than 1km from Bhangra Sway Cremona, so self check-in is blocked. Maybe your browser hasn't shared your location correctly, you can notify your instructor instead.",
        ...
        member_welcome_heading: 'Welcome! 👋',
        member_welcome_body: 'Enter your mobile number to open your student account — check your report, mark attendance, or join a performance.',
        report_hi: 'Hi,',
        progress_intro: "Here's your Bhangra progress report.",
        attendance_heading: '📅 Attendance History',
        ...
        rules_pdf_link: 'Studio Rules',
        certificate_heading: '🩺 Medical Certificate',
        certificate_upload_btn: 'Upload PDF',
        certificate_reupload_btn: 'Upload again',
        certificate_status_none: 'No certificate on file yet — please upload your certificato medico non-agonistico.',
        certificate_status_pending: 'Pending review by the studio.',
        certificate_status_approved: '✅ Approved — on file with the studio.',
        certificate_pdf_only: 'Please choose a PDF file.',
        certificate_sent: 'Certificate sent — the studio will review it.',
        certificate_view_btn: 'View',
        certificate_delete_btn: 'Delete',
        certificate_delete_confirm: 'Delete your medical certificate? You can upload a new one afterwards.',
        certificate_deleted: 'Certificate deleted.',
        invoices_heading: '🧾 My Invoices',
        invoices_none: 'No invoices yet.',
        invoices_download: 'Download',
        photo_heading: '🙂 My Profile',
        photo_locked_no_passcode: 'Set a 4-digit passcode to unlock your profile photo',
        photo_locked_enter_passcode: 'Enter your passcode to view or set a profile photo',
        photo_set_passcode_btn: 'Set Passcode',
        photo_enter_passcode_btn: 'Enter Passcode',
        photo_camera: 'Camera',
        photo_upload: 'Upload',
        photo_retake: 'Retake',
        photo_upload_new: 'Upload New',
        photo_remove: 'Remove Photo',
        credit_heading: '💳 Class Credit',
        credit_subtitle: '€10 per class. Top up anytime with your instructor — no monthly plan to keep track of.',
        credit_ready: 'Ready to dance',
        credit_needs_recharge: 'Recharge needed',
        credit_classes_left: '≈{n} classes left',
        credit_zero_classes: '0 classes left',
        credit_on_credit: '{n} class(es) taken on credit',
        credit_last_recharge: 'Last recharge {date} (€{amount})',
        credit_last_recharge_never: 'Last recharge Never',
        credit_total_classes: 'Total {n} classes danced',
        payment_history_heading: '📜 Payment History',
        payment_history_subtitle: 'Every recharge and class, in order.',
        payment_history_none: 'No transactions yet.',
        credit_row_recharge: 'Recharge',
        credit_row_class: 'Class attended',
        credit_row_adjustment: 'Adjustment',
        show_all_transactions: 'Show all transactions ▾',
        show_less_transactions: 'Show less ▴',
        credit_old_debt_line: '⚠️ You still owe €{amount} from before your credit plan started (last cycle) — please settle this with your instructor.',
        batch_heading: '🥋 My Batch',
        batch_none: 'No batch assigned yet',
        batch_request_btn: 'Request Move',
        batch_request_pending: 'Move request pending: {batch}',
        batch_request_sent: 'Request sent — the studio will review it.',
        ...
        badge_paid_awaiting: '🎁 Paid – Starts After Demo',
        ...
        demo_taken_paid_pill: '🎁 Paid (demo)',
        na: 'N/A',
        demo_note: '🎁 Demo class taken, your plan officially starts on your next attended class.',
        demo_note_paid: "🎁 Demo class taken. We've already received your payment (€{amount}) — your plan officially starts on your next attended class.",
        ...
        // member.html: optional passcode
        passcode_prompt_heading: 'Want a 4-digit passcode?',
        passcode_prompt_body: 'Optional — add a passcode so only you can get into your account, on top of your phone number.',
        passcode_set_btn: 'Set Passcode',
        passcode_skip_btn: 'Skip for now',
        passcode_invalid: 'Enter exactly 4 digits.',
        passcode_enter_heading: 'Enter your passcode',
        passcode_enter_body: 'This member is protected with a passcode.',
        passcode_verify_btn: 'Verify',
        passcode_wrong: 'Incorrect passcode, please try again.',
        passcode_forgot_link: 'Forgot your passcode?',
        passcode_reset_sent_title: 'Request sent',
        passcode_reset_sent_body: "One last step — please confirm on WhatsApp so we know it's really you. Requests aren't approved without this.",
        passcode_wa_btn: 'Send WhatsApp Confirmation',
        passcode_copy_btn: 'Or copy the message to send manually',
        passcode_copied: 'Message copied — paste it in WhatsApp',
        // member.html: placeholders
        grade_heading: 'Your Grade',
        improve_heading: 'What to Improve',
        coming_soon: 'Coming soon',
        // member.html: compact dashboard (tabs + quick-glance chips)
        tab_report: 'Report',
        tab_members: 'Members',
        tab_attendance: 'Attendance',
        tab_grade: 'Grade',
        tab_improve: 'Improve',
        membership_heading_short: 'Status',
        attendance_heading_short: 'Classes',
        gifted_chip_one: '🎁 {n} gifted',
        gifted_chip_many: '🎁 {n} gifted',
        logout_btn: 'Logout',
        cycles_ago_one: '{n} cycle ago',
        cycles_ago_many: '{n} cycles ago',
        paid_on_line: 'Paid on {date} · €{amount}',
        create_password_btn: '🔑 Create Password',
        change_password_btn: '🔑 Change Password',
        pw_save_btn: 'Save Password',
        pw_cancel_btn: 'Cancel',
        pw_saved_msg: '✓ Password saved',
        // member.html: Perform tab (ported from perform.html)
        tab_perform: 'Perform',
        perf_join_btn: "🎭 I'm In!",
        perf_spot_btn: '📍 See My Spot',
        perf_joining: 'Joining…',
        perf_dancers_joined: 'dancers have joined so far',
        perf_back_btn: '← Back',
        perf_closed_title: 'Signups are closed',
        perf_closed_sub: 'This performance call just closed.',
        perf_joined_title: "You're in! 🎉",
        perf_not_joined: "You haven't joined a performance yet.",
        perf_no_positions: "Positions haven't been planned yet — check back closer to the show.",
        ...
        class_advance1_name: 'Advance 1',
        class_advance1_time: 'Saturday, 1:30 PM – 3:30 PM',
        class_advance1_desc: "For dancers who've passed an Intermediate batch, or are already skilled and want to go deeper.",
        class_advance2_name: 'Advance 2',
        class_advance2_time: 'Saturday, 3:30 PM – 5:30 PM',
        class_advance2_desc: "For dancers who've passed an Intermediate batch, or are already skilled and want to go deeper.",
        class_intermediate_name: 'Intermediate',
        class_intermediate_time: 'Sunday, 4:00 PM – 6:00 PM',
        class_intermediate_desc: "Best for dancers who've learned elsewhere, or who've completed our Beginner class.",
        class_beginner1_name: 'Beginner (Level 1)',
        class_beginner1_time: 'Saturday, 5:30 PM – 7:30 PM',
        class_beginner1_desc: "Best for absolute zero level — whether you're a teenager or an adult, no experience needed.",
        class_beginner2_name: 'Beginner (Level 2)',
        class_beginner2_time: 'Sunday, 2:00 PM – 4:00 PM',
        class_beginner2_desc: 'For beginners continuing after Level 1, building on the basics.',
        ...
        footer_address_label: 'Corso XX Settembre 39, 26100 Cremona CR',
        footer_rights: 'All rights reserved.',
        footer_members: 'Members Login',

        // ===== member_v2.html =====
        mv2_welcome_title: 'Welcome',
        mv2_welcome_sub: 'Enter your mobile number to open your account: check your balance, mark attendance, or join a performance.',
        mv2_phone_placeholder: 'e.g. 333 123 4567',
        mv2_continue: 'Continue',
        mv2_pick_title: 'Who are you?',
        mv2_pick_sub: 'More than one member is registered under this number. Pick yourself.',
        mv2_use_different_number: 'Use a different number',
        mv2_passcode_create_title: 'Create a passcode',
        mv2_passcode_create_body: 'Optional, but recommended: protects your balance and photo.',
        mv2_set_passcode_btn: 'Set Passcode',
        mv2_passcode_enter_title: 'Enter your passcode',
        mv2_skip_for_now: 'Skip for now',
        mv2_forgot_passcode: 'Forgot your passcode?',
        mv2_enter_4digit: 'Enter a 4-digit code.',
        mv2_something_wrong: 'Something went wrong.',
        mv2_verification_failed: 'Verification failed.',
        mv2_request_sent_title: 'Request sent',
        mv2_request_sent_sub: "One last step: confirm on WhatsApp so we know it's really you. Requests aren't approved without this.",
        mv2_send_wa_confirm: 'Send WhatsApp Confirmation',
        mv2_copy_manually: 'Or copy the message to send manually',
        mv2_logout: 'Logout',
        mv2_tab_report: 'Report',
        mv2_tab_attendance: 'Attendance',
        mv2_tab_perform: 'Perform',
        mv2_credit_heading: 'Class Credit',
        mv2_credit_sub: '€{rate} per class. Top up anytime with your instructor. No monthly plan to keep track of.',
        mv2_ledger_heading: 'Payment History',
        mv2_ledger_sub: 'Every recharge and class, in order.',
        mv2_batch_heading: 'My Batch',
        mv2_batch_request_btn: 'Request Move',
        mv2_cert_heading: 'Medical Certificate',
        mv2_cert_view_btn: 'View',
        mv2_cert_delete_btn: 'Delete',
        mv2_cert_upload_btn: 'Upload PDF',
        mv2_invoices_heading: 'My Invoices',
        mv2_profile_heading: 'My Profile',
        mv2_hist_heading: 'Historical Record',
        mv2_hist_sub: 'Your record from before 2 September 2026, kept for reference only and separate from your live balance and activity above.',
        mv2_hist_balance_label: 'Balance carried over',
        mv2_hist_payments_label: 'Past Payments',
        mv2_hist_attendance_label: 'Past Attendance',
        mv2_attn_notify_closed: "Can't check in? Notify your instructor",
        mv2_attn_request: 'Request Attendance',
        mv2_attn_confirm: 'Confirm Check-In',
        mv2_settings_title: 'Settings',
        mv2_reset_passcode_heading: 'Reset Passcode',
        mv2_reset_passcode_body: 'Forgot your passcode, or want it reset for any reason? Send a request to your instructor.',
        mv2_reset_passcode_btn: 'Request Passcode Reset',
        mv2_reset_passcode_sent_body: 'Request sent. Confirm on WhatsApp so your instructor sees it right away.'
    },
    ...
    it: {
        ...
        too_far_body: 'La posizione del tuo telefono indica che sei a più di 1 km da Bhangra Sway Cremona, quindi il check-in autonomo è bloccato. Forse il browser non ha condiviso bene la posizione, puoi avvisare il tuo istruttore.',
        ...
        member_welcome_heading: 'Benvenuto! 👋',
        member_welcome_body: 'Inserisci il tuo numero di cellulare per accedere al tuo account studente — controlla il report, segna la presenza o partecipa a uno spettacolo.',
        report_hi: 'Ciao,',
        progress_intro: 'Ecco il tuo report dei progressi di Bhangra.',
        attendance_heading: '📅 Storico Presenze',
        ...
        rules_pdf_link: 'Regolamento della scuola',
        certificate_heading: '🩺 Certificato Medico',
        certificate_upload_btn: 'Carica PDF',
        certificate_reupload_btn: 'Carica di nuovo',
        certificate_status_none: 'Nessun certificato caricato — carica il tuo certificato medico non agonistico.',
        certificate_status_pending: 'In attesa di revisione da parte della scuola.',
        certificate_status_approved: '✅ Approvato — registrato dalla scuola.',
        certificate_pdf_only: 'Seleziona un file PDF.',
        certificate_sent: 'Certificato inviato — la scuola lo esaminerà.',
        certificate_view_btn: 'Visualizza',
        certificate_delete_btn: 'Elimina',
        certificate_delete_confirm: 'Eliminare il tuo certificato medico? Potrai caricarne uno nuovo dopo.',
        certificate_deleted: 'Certificato eliminato.',
        invoices_heading: '🧾 Le mie fatture',
        invoices_none: 'Nessuna fattura per ora.',
        invoices_download: 'Scarica',
        photo_heading: '🙂 Il mio profilo',
        photo_locked_no_passcode: 'Imposta un codice a 4 cifre per sbloccare la tua foto profilo',
        photo_locked_enter_passcode: 'Inserisci il tuo codice per vedere o impostare una foto profilo',
        photo_set_passcode_btn: 'Imposta codice',
        photo_enter_passcode_btn: 'Inserisci codice',
        photo_camera: 'Fotocamera',
        photo_upload: 'Carica',
        photo_retake: 'Rifai foto',
        photo_upload_new: 'Carica nuova',
        photo_remove: 'Rimuovi foto',
        credit_heading: '💳 Credito Lezioni',
        credit_subtitle: '10€ a lezione. Ricarica quando vuoi con il tuo istruttore — niente più quota mensile fissa.',
        credit_ready: 'Pronto a ballare',
        credit_needs_recharge: 'Ricarica necessaria',
        credit_classes_left: '≈{n} lezioni rimaste',
        credit_zero_classes: '0 lezioni rimaste',
        credit_on_credit: '{n} lezione/i presa/e a credito',
        credit_last_recharge: 'Ultima ricarica {date} (€{amount})',
        credit_last_recharge_never: 'Ultima ricarica: Mai',
        credit_total_classes: 'Totale {n} lezioni frequentate',
        payment_history_heading: '📜 Storico Pagamenti',
        payment_history_subtitle: 'Ogni ricarica e lezione, in ordine.',
        payment_history_none: 'Ancora nessuna transazione.',
        credit_row_recharge: 'Ricarica',
        credit_row_class: 'Lezione frequentata',
        credit_row_adjustment: 'Rettifica',
        show_all_transactions: 'Mostra tutte le transazioni ▾',
        show_less_transactions: 'Mostra meno ▴',
        credit_old_debt_line: '⚠️ Devi ancora €{amount} da prima dell\'inizio del credito lezioni (ultimo ciclo) — sistemalo con il tuo istruttore.',
        batch_heading: '🥋 Il mio batch',
        batch_none: 'Nessun batch assegnato',
        batch_request_btn: 'Richiedi cambio',
        batch_request_pending: 'Richiesta di cambio in attesa: {batch}',
        batch_request_sent: 'Richiesta inviata — la scuola la esaminerà.',
        ...
        badge_paid_awaiting: '🎁 Pagato – Inizia dopo la prova',
        ...
        extended_tag: '⏳ estesa',
        closed_early_tag: '🔒 chiuso in anticipo',
        pill_paid: '✅ Pagato',
        ...
        demo_taken_paid_pill: '🎁 Pagato (prova)',
        na: 'N/D',
        demo_note: '🎁 Lezione di prova fatta, il tuo piano parte ufficialmente dalla prossima lezione frequentata.',
        demo_note_paid: '🎁 Lezione di prova fatta. Abbiamo già ricevuto il tuo pagamento (€{amount}) — il tuo piano parte ufficialmente dalla prossima lezione frequentata.',
        ...
        // member.html: passcode opzionale
        passcode_prompt_heading: 'Vuoi un codice a 4 cifre?',
        passcode_prompt_body: 'Facoltativo — aggiungi un codice così solo tu puoi accedere al tuo account, oltre al numero di telefono.',
        passcode_set_btn: 'Imposta codice',
        passcode_skip_btn: 'Salta per ora',
        passcode_invalid: 'Inserisci esattamente 4 cifre.',
        passcode_enter_heading: 'Inserisci il tuo codice',
        passcode_enter_body: 'Questo profilo è protetto da un codice.',
        passcode_verify_btn: 'Verifica',
        passcode_wrong: 'Codice errato, riprova.',
        passcode_forgot_link: 'Hai dimenticato il codice?',
        passcode_reset_sent_title: 'Richiesta inviata',
        passcode_reset_sent_body: "Ultimo passaggio — conferma su WhatsApp così sappiamo che sei davvero tu. Senza questo la richiesta non verrà approvata.",
        passcode_wa_btn: 'Invia conferma su WhatsApp',
        passcode_copy_btn: 'Oppure copia il messaggio da inviare manualmente',
        passcode_copied: 'Messaggio copiato — incollalo su WhatsApp',
        // member.html: placeholder
        grade_heading: 'Il tuo livello',
        improve_heading: 'Da migliorare',
        coming_soon: 'Presto disponibile',
        // member.html: dashboard compatto (tab + riepilogo rapido)
        tab_report: 'Report',
        tab_members: 'Profilo',
        tab_attendance: 'Presenze',
        tab_grade: 'Livello',
        tab_improve: 'Migliora',
        membership_heading_short: 'Stato',
        attendance_heading_short: 'Lezioni',
        gifted_chip_one: '🎁 {n} regalata',
        gifted_chip_many: '🎁 {n} regalate',
        logout_btn: 'Esci',
        cycles_ago_one: '{n} ciclo fa',
        cycles_ago_many: '{n} cicli fa',
        paid_on_line: 'Pagato il {date} · €{amount}',
        create_password_btn: '🔑 Crea Password',
        change_password_btn: '🔑 Cambia Password',
        pw_save_btn: 'Salva Password',
        pw_cancel_btn: 'Annulla',
        pw_saved_msg: '✓ Password salvata',
        // member.html: tab Perform (portato da perform.html)
        tab_perform: 'Esibizioni',
        perf_join_btn: '🎭 Partecipo!',
        perf_spot_btn: '📍 Vedi la Mia Posizione',
        perf_joining: 'Iscrizione…',
        perf_dancers_joined: 'ballerini si sono iscritti finora',
        perf_back_btn: '← Indietro',
        perf_closed_title: 'Iscrizioni chiuse',
        perf_closed_sub: 'Questa chiamata per lo spettacolo si è appena chiusa.',
        perf_joined_title: 'Sei dentro! 🎉',
        perf_not_joined: 'Non hai ancora partecipato a uno spettacolo.',
        perf_no_positions: 'Le posizioni non sono ancora state pianificate — ricontrolla più vicino allo spettacolo.',
        ...
        class_advance1_name: 'Avanzato 1',
        class_advance1_time: 'Sabato, 13:30 – 15:30',
        class_advance1_desc: 'Per chi ha completato un corso Intermedio, o è già esperto e vuole approfondire ancora di più.',
        class_advance2_name: 'Avanzato 2',
        class_advance2_time: 'Sabato, 15:30 – 17:30',
        class_advance2_desc: 'Per chi ha completato un corso Intermedio, o è già esperto e vuole approfondire ancora di più.',
        class_intermediate_name: 'Intermedio',
        class_intermediate_time: 'Domenica, 16:00 – 18:00',
        class_intermediate_desc: 'Ideale per chi ha già imparato altrove o ha completato il nostro corso Principianti.',
        class_beginner1_name: 'Principianti (primo livello)',
        class_beginner1_time: 'Sabato, 17:30 – 19:30',
        class_beginner1_desc: 'Ideale per chi parte da zero, sia adolescenti che adulti.',
        class_beginner2_name: 'Principianti (secondo livello)',
        class_beginner2_time: 'Domenica, 14:00 – 16:00',
        class_beginner2_desc: 'Per chi continua dopo il primo livello, consolidando le basi.',
        ...
        // ===== member_v2.html =====
        mv2_welcome_title: 'Benvenuto',
        mv2_welcome_sub: 'Inserisci il tuo numero di cellulare per accedere al tuo account: controlla il saldo, segna la presenza o partecipa a uno spettacolo.',
        mv2_phone_placeholder: 'es. 333 123 4567',
        mv2_continue: 'Continua',
        mv2_pick_title: 'Chi sei?',
        mv2_pick_sub: 'Più di un membro è registrato con questo numero. Scegli il tuo nome.',
        mv2_use_different_number: 'Usa un altro numero',
        mv2_passcode_create_title: 'Crea un codice',
        mv2_passcode_create_body: 'Facoltativo, ma consigliato: protegge il tuo saldo e la tua foto.',
        mv2_set_passcode_btn: 'Imposta Codice',
        mv2_passcode_enter_title: 'Inserisci il tuo codice',
        mv2_skip_for_now: 'Salta per ora',
        mv2_forgot_passcode: 'Hai dimenticato il codice?',
        mv2_enter_4digit: 'Inserisci un codice a 4 cifre.',
        mv2_something_wrong: 'Qualcosa è andato storto.',
        mv2_verification_failed: 'Verifica non riuscita.',
        mv2_request_sent_title: 'Richiesta inviata',
        mv2_request_sent_sub: 'Un ultimo passo: conferma su WhatsApp così sappiamo che sei davvero tu. Le richieste non vengono approvate senza questo.',
        mv2_send_wa_confirm: 'Invia Conferma WhatsApp',
        mv2_copy_manually: 'Oppure copia il messaggio per inviarlo manualmente',
        mv2_logout: 'Esci',
        mv2_tab_report: 'Report',
        mv2_tab_attendance: 'Presenze',
        mv2_tab_perform: 'Spettacoli',
        mv2_credit_heading: 'Credito Lezioni',
        mv2_credit_sub: "€{rate} a lezione. Ricarica quando vuoi con il tuo istruttore. Nessun abbonamento mensile da tenere sott'occhio.",
        mv2_ledger_heading: 'Storico Pagamenti',
        mv2_ledger_sub: 'Ogni ricarica e lezione, in ordine.',
        mv2_batch_heading: 'Il Mio Gruppo',
        mv2_batch_request_btn: 'Richiedi Cambio',
        mv2_cert_heading: 'Certificato Medico',
        mv2_cert_view_btn: 'Visualizza',
        mv2_cert_delete_btn: 'Elimina',
        mv2_cert_upload_btn: 'Carica PDF',
        mv2_invoices_heading: 'Le Mie Fatture',
        mv2_profile_heading: 'Il Mio Profilo',
        mv2_hist_heading: 'Storico',
        mv2_hist_sub: 'Il tuo storico da prima del 2 settembre 2026, tenuto solo come riferimento e separato dal saldo e attività in tempo reale qui sopra.',
        mv2_hist_balance_label: 'Saldo riportato',
        mv2_hist_payments_label: 'Pagamenti Passati',
        mv2_hist_attendance_label: 'Presenze Passate',
        mv2_attn_notify_closed: 'Non riesci a fare il check-in? Avvisa il tuo istruttore',
        mv2_attn_request: 'Richiedi Presenza',
        mv2_attn_confirm: 'Conferma Check-In',
        mv2_settings_title: 'Impostazioni',
        mv2_reset_passcode_heading: 'Reimposta Codice',
        mv2_reset_passcode_body: 'Hai dimenticato il codice, o vuoi reimpostarlo per un altro motivo? Invia una richiesta al tuo istruttore.',
        mv2_reset_passcode_btn: 'Richiedi Reset Codice',
        mv2_reset_passcode_sent_body: 'Richiesta inviata. Conferma su WhatsApp così il tuo istruttore la vede subito.'
    },
    ...
    pa: {
        ...
        too_far_body: 'Tuhade phone di location mutabik tusi Bhangra Sway Cremona ton 1km ton vadh door ho, is layi self check-in band hai. Ho sakda browser ne location theek share nahi kiti, tusi instructor nu das sakde ho.',
        ...
        member_welcome_heading: 'Jee Aayan Nu! 👋',
        member_welcome_body: 'Apna student account kholan layi mobile number likho — report vekho, haazri lagao, ja performance vich join karo.',
        report_hi: 'Sat Sri Akal,',
        progress_intro: 'Eh hai tuhadi Bhangra progress report.',
        attendance_heading: '📅 Puri Haazri History',
        ...
        rules_pdf_link: 'Studio Rules',
        certificate_heading: '🩺 Medical Certificate',
        certificate_upload_btn: 'PDF Upload Karo',
        certificate_reupload_btn: 'Dubara Upload Karo',
        certificate_status_none: 'Hale koi certificate nahi hai — apna certificato medico non-agonistico upload karo.',
        certificate_status_pending: 'Studio review kar riha hai.',
        certificate_status_approved: '✅ Approved — studio kol record hai.',
        certificate_pdf_only: 'Kirpa karke PDF file chuno.',
        certificate_sent: 'Certificate bhej ditta — studio ise dekhega.',
        certificate_view_btn: 'Dekho',
        certificate_delete_btn: 'Delete Karo',
        certificate_delete_confirm: 'Apna medical certificate delete karna hai? Baad ch nava upload kar sakde ho.',
        certificate_deleted: 'Certificate delete ho gaya.',
        invoices_heading: '🧾 Meriyan Invoices',
        invoices_none: 'Hale koi invoice nahi.',
        invoices_download: 'Download Karo',
        photo_heading: '🙂 Meri Profile',
        photo_locked_no_passcode: 'Profile photo unlock karan layi 4-digit passcode set karo',
        photo_locked_enter_passcode: 'Profile photo dekhan ja set karan layi apna passcode paao',
        photo_set_passcode_btn: 'Passcode Set Karo',
        photo_enter_passcode_btn: 'Passcode Paao',
        photo_camera: 'Camera',
        photo_upload: 'Upload',
        photo_retake: 'Dubara Khichcho',
        photo_upload_new: 'Nayi Upload Karo',
        photo_remove: 'Photo Hatao',
        credit_heading: '💳 Class Credit',
        credit_subtitle: 'Har class da 10€. Apne instructor kol jado v recharge karo — koi monthly plan track karan di lod nahi.',
        credit_ready: 'Nachan layi tiyaar',
        credit_needs_recharge: 'Recharge di lod hai',
        credit_classes_left: '≈{n} classes bachiyan',
        credit_zero_classes: '0 classes bachiyan',
        credit_on_credit: '{n} class(an) credit te lai',
        credit_last_recharge: 'Aakhri recharge {date} (€{amount})',
        credit_last_recharge_never: 'Aakhri recharge: Kadi nahi',
        credit_total_classes: 'Total {n} classes lgayian',
        payment_history_heading: '📜 Payment History',
        payment_history_subtitle: 'Har recharge te class, tartib naal.',
        payment_history_none: 'Hale takk koi transaction nahi.',
        credit_row_recharge: 'Recharge',
        credit_row_class: 'Class lagayi',
        credit_row_adjustment: 'Adjustment',
        show_all_transactions: 'Sari transactions dikhao ▾',
        show_less_transactions: 'Ghat dikhao ▴',
        credit_old_debt_line: '⚠️ Tusi credit plan shuru hon ton pehla da €{amount} ajje v denda hai (aakhri cycle) — apne instructor naal ehnu clear karo.',
        batch_heading: '🥋 Mera Batch',
        batch_none: 'Hale koi batch assign nahi hoya',
        batch_request_btn: 'Batch Change Manggo',
        batch_request_pending: 'Batch change request pending hai: {batch}',
        batch_request_sent: 'Request bhej ditti — studio ise dekhega.',
        membership_heading: '💳 Membership Status',
        ...
        badge_paid_awaiting: '🎁 Bharia hoya – Demo ton baad shuru',
        ...
        closed_early_tag: '🔒 pehla band',
        pill_paid: '✅ Bharia',
        pill_unpaid: '❌ Baaki',
        pill_gratis: '🤝 Nipatara',
        ...
        demo_taken_paid_pill: '🎁 Bharia (demo)',
        na: 'N/A',
        demo_note: '🎁 Demo class layi gayi, tuhada plan agli attend kiti class ton shuru hovega.',
        demo_note_paid: '🎁 Demo class layi gayi. Tuhadi payment (€{amount}) sadde kol pahunch chuki hai — tuhada plan agli attend kiti class ton shuru hovega.',
        ...
        // member.html: optional passcode
        passcode_prompt_heading: '4-digit passcode chahida?',
        passcode_prompt_body: 'Optional hai — passcode laga ke sirf tusi hi apna account khol sakde ho, phone number de naal naal.',
        passcode_set_btn: 'Passcode Set Karo',
        passcode_skip_btn: 'Hun skip karo',
        passcode_invalid: 'Poore 4 ank likho.',
        passcode_enter_heading: 'Apna passcode likho',
        passcode_enter_body: 'Eh member passcode naal protect hai.',
        passcode_verify_btn: 'Verify Karo',
        passcode_wrong: 'Passcode galat hai, dubara koshish karo.',
        passcode_forgot_link: 'Passcode bhul gaye?',
        passcode_reset_sent_title: 'Request bhej diti',
        passcode_reset_sent_body: "Ek aakhri step — WhatsApp te confirm karo tan ke sanu pata lagge eh tusi ho. Es bina request approve nahi hondi.",
        passcode_wa_btn: 'WhatsApp Confirmation Bhejo',
        passcode_copy_btn: 'Ja message copy karke khud bhejo',
        passcode_copied: 'Message copy ho gaya — WhatsApp te paste karo',
        // member.html: placeholder
        grade_heading: 'Tuhada Grade',
        improve_heading: 'Ki Sudharan Hai',
        coming_soon: 'Jald aa raha hai',
        // member.html: compact dashboard (tabs + quick-glance chips)
        tab_report: 'Report',
        tab_members: 'Members',
        tab_attendance: 'Haazri',
        tab_grade: 'Grade',
        tab_improve: 'Sudhar',
        membership_heading_short: 'Status',
        attendance_heading_short: 'Classes',
        gifted_chip_one: '🎁 {n} gift class',
        gifted_chip_many: '🎁 {n} gift classes',
        logout_btn: 'Logout',
        cycles_ago_one: '{n} cycle pehla',
        cycles_ago_many: '{n} cycles pehla',
        paid_on_line: '{date} nu paid kita · €{amount}',
        create_password_btn: '🔑 Password Banao',
        change_password_btn: '🔑 Password Badlo',
        pw_save_btn: 'Password Save Karo',
        pw_cancel_btn: 'Cancel',
        pw_saved_msg: '✓ Password save ho gaya',
        // member.html: Perform tab (perform.html ton port kita)
        tab_perform: 'Perform',
        perf_join_btn: "🎭 Main Vich Haan!",
        perf_spot_btn: '📍 Meri Spot Vekho',
        perf_joining: 'Join ho raha hai…',
        perf_dancers_joined: 'dancers hun tak join kar chuke ne',
        perf_back_btn: '← Waapas',
        perf_closed_title: 'Signups band ho gaye ne',
        perf_closed_sub: 'Eh performance call hun band ho gayi hai.',
        perf_joined_title: "Tusi vich ho! 🎉",
        perf_not_joined: 'Tusi ajje kise performance vich join nahi kita.',
        perf_no_positions: 'Positions ajje plan nahi hoye — show de nede check karo.',
        ...
        class_advance1_name: 'Advance 1',
        class_advance1_time: 'Saturday, 1:30 PM – 3:30 PM',
        class_advance1_desc: 'Ohna layi jo students intermediate batch pass kar chukke ne ya fer pehla hi pro ne te hor depth vich sikhna chahunde ne.',
        class_advance2_name: 'Advance 2',
        class_advance2_time: 'Saturday, 3:30 PM – 5:30 PM',
        class_advance2_desc: 'Ohna layi jo students intermediate batch pass kar chukke ne ya fer pehla hi pro ne te hor depth vich sikhna chahunde ne.',
        class_intermediate_name: 'Intermediate',
        class_intermediate_time: 'Sunday, 4:00 PM – 6:00 PM',
        class_intermediate_desc: 'Ohna layi jinhan ne kitte hor sikhya hove ja saadi Beginner class pass keeti hove.',
        class_beginner1_name: 'Beginner (Level 1)',
        class_beginner1_time: 'Saturday, 5:30 PM – 7:30 PM',
        class_beginner1_desc: 'Bilkul zero level layi best — chahe teenager ho ja adult, koi tajurbe di lorh nahi.',
        class_beginner2_name: 'Beginner (Level 2)',
        class_beginner2_time: 'Sunday, 2:00 PM – 4:00 PM',
        class_beginner2_desc: 'Level 1 mukan tho baad continue karan walean layi, basics nu hor pakka karda.',
        ...
        // ===== member_v2.html =====
        mv2_welcome_title: 'Jee Aayan Nu',
        mv2_welcome_sub: 'Apna mobile number pao apna account kholan layi: balance check karo, haazri lagao, ja performance vich shamil hovo.',
        mv2_phone_placeholder: 'jiven 333 123 4567',
        mv2_continue: 'Agge vadho',
        mv2_pick_title: 'Tusi kaun ho?',
        mv2_pick_sub: 'Is number te ikk ton vadh member registered han. Apna naam chuno.',
        mv2_use_different_number: 'Koi hor number varto',
        mv2_passcode_create_title: 'Passcode banao',
        mv2_passcode_create_body: 'Zaroori nahi, par changa rahega: eh tuhada balance te photo surakhit rakhda hai.',
        mv2_set_passcode_btn: 'Passcode Set Karo',
        mv2_passcode_enter_title: 'Apna passcode pao',
        mv2_skip_for_now: 'Hune chhad do',
        mv2_forgot_passcode: 'Passcode bhul gaye?',
        mv2_enter_4digit: '4-ank da code pao.',
        mv2_something_wrong: 'Kujh galat ho gaya.',
        mv2_verification_failed: 'Verification fail ho gayi.',
        mv2_request_sent_title: 'Request bhej ditti',
        mv2_request_sent_sub: 'Ikk aakhri kadam: WhatsApp te confirm karo taan jo pata lage eh sach vich tusi ho. Es tor bina request approve nahi hondi.',
        mv2_send_wa_confirm: 'WhatsApp Confirmation Bhejo',
        mv2_copy_manually: 'Ja message copy karke khud bhejo',
        mv2_logout: 'Logout',
        mv2_tab_report: 'Report',
        mv2_tab_attendance: 'Haazri',
        mv2_tab_perform: 'Performance',
        mv2_credit_heading: 'Class Credit',
        mv2_credit_sub: '€{rate} har class layi. Jado marzi instructor kol recharge karvao. Koi monthly plan yaad rakhan di lod nahi.',
        mv2_ledger_heading: 'Payment History',
        mv2_ledger_sub: 'Har recharge te class, tartib naal.',
        mv2_batch_heading: 'Mera Batch',
        mv2_batch_request_btn: 'Move Di Request',
        mv2_cert_heading: 'Medical Certificate',
        mv2_cert_view_btn: 'Vekho',
        mv2_cert_delete_btn: 'Delete Karo',
        mv2_cert_upload_btn: 'PDF Upload Karo',
        mv2_invoices_heading: 'Meriyan Invoices',
        mv2_profile_heading: 'Mera Profile',
        mv2_hist_heading: 'Purana Record',
        mv2_hist_sub: '2 September 2026 ton pehla da tuhada record, sirf reference layi rakhya hoya te upar diti live balance/activity ton vakhra.',
        mv2_hist_balance_label: 'Aage vadhiya balance',
        mv2_hist_payments_label: 'Purane Payments',
        mv2_hist_attendance_label: 'Purani Haazri',
        mv2_attn_notify_closed: 'Check-in nahi ho riha? Instructor nu daso',
        mv2_attn_request: 'Haazri Di Request',
        mv2_attn_confirm: 'Check-In Confirm Karo',
        mv2_settings_title: 'Settings',
        mv2_reset_passcode_heading: 'Passcode Reset Karo',
        mv2_reset_passcode_body: 'Passcode bhul gaye, ja kise hor karan reset karvauna hai? Instructor nu request bhejo.',
        mv2_reset_passcode_btn: 'Passcode Reset Di Request',
        mv2_reset_passcode_sent_body: 'Request bhej ditti. WhatsApp te confirm karo taan jo instructor nu turant pata lag jave.'
    }
};
